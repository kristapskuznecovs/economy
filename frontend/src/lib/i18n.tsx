...
const DICTIONARY: Record<Locale, Record<string, string>> = {
  lv: {
    ...
    'index.mode.dashboard': 'Fiskālais panelis',
    'index.mode.policy': 'TUA un slodze',
    ...
    'migration.title': 'Ārvalstnieki Latvijā: reģistrētie iedzīvotāji un neto migrācija',
    'migration.subtitle': 'PMLP reģistrēto iedzīvotāju sadalījums pēc valstiskās piederības + Pasaules Bankas neto migrācija',
    'migration.loading': 'Ielādē migrācijas datus...',
    'migration.failed': 'Neizdevās ielādēt migrācijas datus',
    'migration.snapshotDate': 'Datu datums',
    'migration.totalResidents': 'Reģistrētie iedzīvotāji',
    'migration.registered': 'PMLP reģistrā',
    'migration.foreignNationals': 'Ārvalstu pilsoņi',
    'migration.ofTotal': 'no kopā',
    'migration.tempProtection': 'Pagaidu aizsardzība',
    'migration.warRefugees': 'kara bēgļi (UA)',
    'migration.vsPrevSnapshot': 'pret iepriekšējo',
    'migration.nonCitizens': 'Latvijas nepilsoņi',
    'migration.latvianNonCitizens': 'bez pilsonības statusa',
    'migration.selectSnapshot': 'Izvēlies datu datumu',
    'migration.persons': 'personas',
    'migration.topNationalities.title': 'Top ārvalstu pilsoņi',
    'migration.topNationalities.subtitle': 'Lielākās grupas pēc valstiskās piederības',
    'migration.foreignTrend.title': 'Ārvalstnieki laikā',
    'migration.foreignTrend.subtitle': 'PMLP snapšoti kopš 2019. gada',
    'migration.netMigration.title': 'Neto migrācija (Pasaules Banka)',
    'migration.netMigration.subtitle': 'Imigranti mīnus emigranti gadā (+ = pieaugums)',
    'migration.netMigration.label': 'Neto migrācija',
    'migration.netMigration.note': 'Zaļš = pozitīvs saldo, sarkans = negatīvs saldo. Avots: World Bank SM.POP.NETM.',
    'migration.caveat.title': 'Ko šie dati neparāda',
    'migration.caveat.body': 'PMLP reģistrs rāda reģistrētos iedzīvotājus, nevis darba atļaujas vai nodarbinātības sektorus. Nozaru sadalījums (ražošana, būvniecība u.c.) nav pieejams kā strukturēts publisks datu kopums Latvijā.',
    'migration.source': 'Avoti: PMLP (data.gov.lv datukopa {pmlp}), Pasaules Banka ({wb}).',
  ...
  en: {
    ...
    'index.mode.dashboard': 'Fiscal dashboard',
    'index.mode.policy': 'Permits and pressure',
    ...
    'migration.title': 'Foreign nationals in Latvia: registered residents & net migration',
    'migration.subtitle': 'OCMA registered residents by citizenship + World Bank net migration series',
    'migration.loading': 'Loading migration data...',
    'migration.failed': 'Failed to load migration data',
    'migration.snapshotDate': 'Data date',
    'migration.totalResidents': 'Registered residents',
    'migration.registered': 'in OCMA register',
    'migration.foreignNationals': 'Foreign nationals',
    'migration.ofTotal': 'of total',
    'migration.tempProtection': 'Temporary protection',
    'migration.warRefugees': 'war refugees (UA)',
    'migration.vsPrevSnapshot': 'vs prev snapshot',
    'migration.nonCitizens': 'Latvian non-citizens',
    'migration.latvianNonCitizens': 'without citizenship status',
    'migration.selectSnapshot': 'Select data date',
    'migration.persons': 'persons',
    'migration.topNationalities.title': 'Top foreign nationals',
    'migration.topNationalities.subtitle': 'Largest groups by citizenship',
    'migration.foreignTrend.title': 'Foreign nationals over time',
    'migration.foreignTrend.subtitle': 'OCMA snapshots since 2019',
    'migration.netMigration.title': 'Net migration (World Bank)',
    'migration.netMigration.subtitle': 'Immigrants minus emigrants per year (+ = population gain)',
    'migration.netMigration.label': 'Net migration',
    'migration.netMigration.note': 'Green = positive balance, red = negative. Source: World Bank SM.POP.NETM.',
    'migration.caveat.title': 'What this data does not show',
    'migration.caveat.body': 'The OCMA register shows registered residents, not work permits or employment sectors. A clean public dataset with sector breakdown (manufacturing, construction, etc.) for foreign workers does not exist in Latvia\'s open data.',
    'migration.source': 'Sources: OCMA/PMLP (data.gov.lv dataset {pmlp}), World Bank ({wb}).',
